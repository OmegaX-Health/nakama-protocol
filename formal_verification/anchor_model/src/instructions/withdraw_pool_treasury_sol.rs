...
use crate::WithdrawPoolTreasurySol;

impl<'info> WithdrawPoolTreasurySol<'info> {
    #[qed(verified, spec = "../../omegax_protocol.qedspec", handler = "withdraw_pool_treasury_sol", hash = "b884f7310afb9b01", spec_hash = "68762f8bae5d3e06")]
    #[inline(always)]
