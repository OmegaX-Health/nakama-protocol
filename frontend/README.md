...
- `lib/protocol/` contains shared protocol constants, address/PDA helpers, hex/seed encoding helpers, and structural snapshot/read-model types used by that barrel
