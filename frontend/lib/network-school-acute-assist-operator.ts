...
const NETWORK_SCHOOL_BOOTSTRAP_FUNDING_LINES: readonly NetworkSchoolAcuteAssistBootstrapFundingLine[] = [
  ...
  {
    key: "long-termer-premium",
    displayName: "NS Long-Termer Guarded member premiums",
    lineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.fundingLineIds.premium,
    lineType: FUNDING_LINE_TYPE_PREMIUM_INCOME,
    fundingPriority: 2,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.seriesId,
    skuKey: "longTermer",
  },
  {
    key: "long-termer-liquidity",
    displayName: "NS Long-Termer Guarded acute-pool reserve lane",
    lineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.fundingLineIds.liquidity,
    lineType: FUNDING_LINE_TYPE_LIQUIDITY_POOL_ALLOCATION,
    fundingPriority: 3,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.seriesId,
    skuKey: "longTermer",
  ...
  {
    key: "family-guarded-premium",
    displayName: "NS Family Guarded member premiums",
    lineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.fundingLineIds.premium,
    lineType: FUNDING_LINE_TYPE_PREMIUM_INCOME,
    fundingPriority: 4,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.seriesId,
    skuKey: "familyGuarded",
  },
  {
    key: "family-guarded-liquidity",
    displayName: "NS Family Guarded acute-pool reserve lane",
    lineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.fundingLineIds.liquidity,
    lineType: FUNDING_LINE_TYPE_LIQUIDITY_POOL_ALLOCATION,
    fundingPriority: 5,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.seriesId,
    skuKey: "familyGuarded",
...
const NETWORK_SCHOOL_BOOTSTRAP_ALLOCATIONS: readonly NetworkSchoolAcuteAssistBootstrapAllocation[] = [
  ...
  {
    key: "long-termer-junior",
    classId: NETWORK_SCHOOL_ACUTE_ASSIST_JUNIOR_CLASS_ID,
    fundingLineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.fundingLineIds.liquidity,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.longTermer.seriesId,
    skuKey: "longTermer",
    capAmount: 1_000n,
    weightBps: 2_000,
  ...
  {
    key: "family-guarded-junior",
    classId: NETWORK_SCHOOL_ACUTE_ASSIST_JUNIOR_CLASS_ID,
    fundingLineId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.fundingLineIds.liquidity,
    policySeriesId: NETWORK_SCHOOL_ACUTE_ASSIST_SKUS.familyGuarded.seriesId,
    skuKey: "familyGuarded",
    capAmount: 1_500n,
    weightBps: 3_000,
...
> = {
  not_created: {
    ...
    detail: "Create the invite-gated plan, three guarded series, funding lines, and acute-pool allocations first.",
  },
  shell_incomplete: {
    label: "Shell incomplete",
    title: "Canonical NS Acute objects are still missing",
    detail: "The plan, guarded series, funding lines, shared pool, classes, and allocation positions must match the template.",
  },
  verifier_pending: {
...
export function buildNetworkSchoolAcuteAssistSetupModel(
  ...
  const checklist = {
    ...
    capitalClassesReady,
    allocationsReady,
    reserveTargetReviewReady: Boolean(input.readiness?.poolTermsConfigured) && claimsPayingCapital >= 5_000n,
